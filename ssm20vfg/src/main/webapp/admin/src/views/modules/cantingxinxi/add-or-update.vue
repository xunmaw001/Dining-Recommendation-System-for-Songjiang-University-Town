<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="餐厅星级" prop="cantingxingji">
          <el-select :disabled="ro.cantingxingji" v-model="ruleForm.cantingxingji" placeholder="请选择餐厅星级">
            <el-option
                v-for="(item,index) in cantingxingjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="餐厅星级" prop="cantingxingji">
	      <el-input v-model="ruleForm.cantingxingji"
                placeholder="餐厅星级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="特色菜" prop="tesecai">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="特色菜"
                  v-model="ruleForm.tesecai" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tesecai" label="特色菜" prop="tesecai">
                    <span>{{ruleForm.tesecai}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cantingmingcheng = true;
          ...
          if(o=='cantingxingji'){
            this.ruleForm.cantingxingji = obj[o];
	    this.ro.cantingxingji = true;
            continue;
          }
          if(o=='cantingtupian'){
	    ...
	    this.ro.cantingtupian = true;
          ...
          if(o=='tesecai'){
            this.ruleForm.tesecai = obj[o];
	    this.ro.tesecai = true;
            continue;
          }
          if(o=='cantingdizhi'){
	...
	this.ruleForm.cantingjieshao = this.ruleForm.cantingjieshao.replace(reg,'../../../ssm20vfg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
